...
//Otçul hayvanları temsil eden Animal alt sınıfını oluşturuyorum.
class Herbivore(name: String, species: String, diet: String, habitat: String) : Animal(name, species, diet, habitat)