...
//Hem etçil hem otçul hayvanları temsil eden Animal alt sınıfını oluşturuyorum.
class Omnivore(name: String, species: String, diet: String, habitat: String) : Animal(name, species, diet, habitat)
