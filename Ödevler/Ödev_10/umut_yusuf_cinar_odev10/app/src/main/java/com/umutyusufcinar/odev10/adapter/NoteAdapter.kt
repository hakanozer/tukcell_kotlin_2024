package com.umutyusufcinar.odev10.adapter
...
import com.umutyusufcinar.odev10.databinding.RecyclerRowNoteBinding
...
class NoteAdapter(private var notes: List<Note>) : RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    //dışarıdaki sınıfın özelliklerine erişebilmek için inner kullanacağım
