...
class DetailsActivity : AppCompatActivity() {
    ...
    //gerekli değişkenleri tanımlıyorum
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //xml elementlerini ID ye göre eşleştirme yapacağım
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main)) { v, insets ->
            val systemBars = insets.getInsets(WindowInsetsCompat.Type.systemBars())
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, systemBars.bottom)
            insets
        }
        //deprecated olmuş ama derste de bu yapı kullanıldığı için kullanmaya devam edeceğim
        ...
        //bindig ile yaparken hata aldım o yüzden id ile yapacağım
        //isimlendirmeleri gelen servise göre kullanmaya dikkat etmeliyiz

        //Intent veya Bundle ile gelen veriyi alırken
        //null exception hatası almamak için kontrol kodu yazıyorum
